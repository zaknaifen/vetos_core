					...
					<form name="f" method="post" action="">
	                	...
	                	<table class="mo_wpum_display_table">
	                		<tr>
								<td>
									<b>Field Label: </b>
									<input type="textbox" id="field_label" name="field_label" style="margin-top:20px; margin-left:10px;" placeholder="" /><br><br><br>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td><br><br>
									...
									<input type="radio" id="field_type" name="field_type" value="text" style="margin-left:17px;"<?php checked( get_option('field_type') == 'text' );?>/>Textbox <br><br>	
							...
							<tr>
								<td>
									<b>Field Option: </b>
									<input type="textbox" name="field_option" id="field_option" style="margin-left:10px;" /><br>
								</td>
							</tr>
							<tr>
								<td>
									<font size="2.0" face='Sans'>(Above field is only required if you have selected field type as radio button/checkbox, to mention names of different options.)<br><br>
...
function mo_wpum_edit_field_pages($id){
	...
	?>
		<div class = "mo_wpum_table_layout"style = "margin-top:50px; margin-right:25px; width:75%">
			...
			<form id="mo-wpum-field" name="mo-wpum-field" method="post" action="<?php echo $url?>">
				...
				<input type="radio" id="field_type" name="field_type" value="textbox" style="margin-left:17px;"<?php checked( get_option('field_type') == 'textbox' );?>/>Textbox <br><br>	
				<input type="radio" id="field_type" name="field_type" value="radio" style="margin-left:173px;"<?php checked( get_option('field_type') == 'radio' );?> />Radio <br><br>	
				<input type="radio" id="field_type" name="field_type" value="textarea" style="margin-left:173px;"<?php checked( get_option('field_type') == 'textarea' );?> />Text Area <br><br>	
				<input type="radio" id="field_type" name="field_type" value="checkbox" style="margin-left:173px;"<?php checked( get_option('field_type') == 'checkbox' );?> />Checkbox <br><br>	<br>
