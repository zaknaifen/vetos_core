...
class Mo_Manager_Plugin{
	...
	function __construct() {
		...
		add_action('show_user_profile',array( $custom_fields_actions, 'wpum_custom_profile_fields'),1,3);
		add_action('edit_user_profile',array( $custom_fields_actions, 'wpum_custom_profile_fields'),1,3);
		add_action('personal_options_update',array( $custom_fields_actions, 'wpum_custom_profile_fields_update' ),1,3);
		add_action('edit_user_profile_update',array( $custom_fields_actions, 'wpum_custom_profile_fields_update' ),1,3);
	...
	function mo_wpum_activate(){
		update_option( 'mo_wpum_host_name', 'https://auth.miniorange.com' );
